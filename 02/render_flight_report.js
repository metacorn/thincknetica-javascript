/**
 * Функция отрисовки данных о рейсе (возвращаемых функцией flightReport()) и его билетах
 *
 ...
 */
 ...
 // т.к. использовал для получения данных о рейсе функцию из предыдущего д/з, добавил параметр nowTime в вызов
